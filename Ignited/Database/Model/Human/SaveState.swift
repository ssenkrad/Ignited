...
extension SaveState: Syncable
{
    ...
    public var isSyncingEnabled: Bool {
        ...
        let isSyncingEnabled = (self.type != .rewind) && (self.game?.identifier != Game.melonDSBIOSIdentifier && self.game?.identifier != Game.melonDSDSiBIOSIdentifier)
    ...
    public func awakeFromSync(_ record: AnyRecord)
    {
        ...
        {
            self.coreIdentifier = system.deltaCore.identifier
        }
    }
